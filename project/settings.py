...
import os
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "moodMatch.settings")
...
PAYMENT_HOST = 'https://www.mercadopago.com'
PAYMENT_PROCESSOR = 'payments.mercadopago.MercadoPagoProvider'
